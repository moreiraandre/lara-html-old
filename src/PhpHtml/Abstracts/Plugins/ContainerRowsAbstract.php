<?php
/**
 * Define o padrão de um plugin que armazena Linhas
 *
...
abstract class ContainerRowsAbstract extends PluginAbstract
{
    /**
     * @var array Armazena linhas
     */
    private $rows = null;

    /**
     * @var null|Row Linha atual
     */
